...
//get all subforums
app.get('/subforums', (req, res, next) => {
...
app.get('/subforumthreads/:name', function(req, res, next){
...
app.get('/viewmessages/:email', function(req, res, next){
...
/* View thread. */
app.get('/thread/:name/:id', function(req, res, next){
...
app.get('/comments/:name/:id', function(req, res, next){
...
app.get('/user/:email/:pass', function(req, res, next){
...
app.get('/isadminuser/:email', function(req, res, next){
...
app.get('/deleteuser/:email', function(req, res, next){
...
app.get('/superfan', function(req, res, next){
  connection.query(`
...
app.get('/ageofworstavgbobo', function(req, res, next){
  connection.query(`
  SELECT *
  FROM(
...
app.get('/ageofbestavgbobo', function(req, res, next){
  connection.query(`
  SELECT *
  FROM(
  SELECT AVG(banana_score)AS AvgBananaScore, age
...
app.get('/ageofgrandbobo', function(req, res, next){
  connection.query(`
  SELECT DISTINCT age
  FROM account
  WHERE age = (
...
app.get('/ageofbabybobo', function(req, res, next){
  connection.query(`
  SELECT DISTINCT age
  FROM account
  WHERE age = (
...
app.get('/bestbobo', function(req, res, next){
  connection.query(`
  SELECT *
  FROM account
  WHERE banana_score = (
...
app.get('/modcheck/:email/:name', function(req, res, next){
...
app.get('/addmod/:email/:name', function(req, res, next){
...
app.get('/addsubforum/:name', function(req, res, next){
...
app.get('/removesubforum/:name', function(req, res, next){
...
app.get('/removemod/:email/:name', function(req, res, next){
...
app.get('/createthread/:name/:title/:body/:author', function(req, res, next){
...
app.get('/deletethread/:id/:author', function(req, res, next){
...
app.get('/updatebscore/:email/:score', function(req, res, next){
  connection.query(`
  UPDATE account
...
app.get('/top20bscore', function(req, res, next){
...
///!!! may need to fix
  /*  Delete a comment  */
app.get('/deletecomment/:name/:cid/:tid', function(req, res, next){
  ...
  /* adds a new response. */
app.get('/newreply/:name/:tid/:email/:body', function(req, res, next){
...
app.get('/query/:select/:from/:where', (req, res, next) => {
  connection.query(
...
app.get('/queryw/:select/:from', (req, res, next) => {
  connection.query(
...
app.use(function(error, req, res, next) {
  ...
  res.send([{error : {code: error.code, sqlMessage:error.sqlMessage}}]);
