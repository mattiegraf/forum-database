...
$db_conn = OCILogon("ora_k4e1b", "a17041154", "dbhost.ugrad.cs.ubc.ca:1522/ug");

///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////

// SQL queries (stored as strings)
// - i know it's gross
...
// initialize tables:
// $initTables is an array of strings, each containing an individual SQL query
$initTables = array(
    ...
    "CREATE TABLE subforum(name CHAR(50) PRIMARY KEY)",
...
if ($db_conn) {
    ...
    if (array_key_exists('reset', $_POST)) {
        ...
        for ($i = 0; $i < count($dropTables); $i++) {
            executePlainSQL($dropTables[$i]);
        }

        // initialize tables:
        echo "<br> initializing tables <br>";
        for ($i = 0; $i < count($initTables); $i++) {
            executePlainSQL($initTables[$i]);
        }
...
// GIVEN FUNCTIONS (don't touch these)
// - these functions let us use SQL to modify the database
